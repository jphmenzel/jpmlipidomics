...
"C:\Users\menzel2\AppData\Local\Programs\Python\Python39\python.exe" "%~dp0\OzFAD1_py\OzFAD1_py_black_box\jpmlipidomics_4_jpmtsvtocsv.py"

rem Filter results and prepare for manual skyline analysis
"C:\Users\menzel2\AppData\Local\Programs\Python\Python39\python.exe" "%~dp0\OzFAD1_py\OzFAD1_py_black_box\jpmlipidomics_4_filter2_tr.py"
