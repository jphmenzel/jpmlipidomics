...
if convertfile==1:
	...
	try:
	    with open(r'skyl_xic_dda_report_vpw20_1.tsv', 'r', newline='\n') as in_f, \
	         open(r'skyl_xic_dda_report_vpw20_1_intensities.csv', 'w', newline='\n') as out_f:
	...
	with open('skyl_xic_dda_report_vpw20_1_intensities.csv', "r+", encoding="utf-8") as csv_file:
	    content = csv_file.read()
	with open('skyl_xic_dda_report_vpw20_1_intensities.csv', "w+", encoding="utf-8") as csv_file:
	...
	tempdf=pd.read_csv('skyl_xic_dda_report_vpw20_1_intensities.csv', header=None, skiprows=1)
	...
	filename='skyl_xic_dda_report_vpw20_1_intensities.csv'
...
if convertfile==1:
	...
	try:
	    with open(r'skyl_xic_dda_report_vpw20_1.tsv', 'r', newline='\n') as in_f, \
	         open(r'skyl_xic_dda_report_vpw20_1_times.csv', 'w', newline='\n') as out_f:
	        reader = csv.reader(in_f, delimiter='\t')
	        writer = csv.writer(out_f, delimiter=',')
	        for li in reader:
	            try:
	...
	# end convert tsv file generated from Skyline runner to csv file
	# begin delete double quotes from generated csv file
	with open('skyl_xic_dda_report_vpw20_1_times.csv', "r+", encoding="utf-8") as csv_file:
	    content = csv_file.read()
	with open('skyl_xic_dda_report_vpw20_1_times.csv', "w+", encoding="utf-8") as csv_file:
	    csv_file.write(content.replace('"', ''))
	...
	filename='skyl_xic_dda_report_vpw20_1_times.csv'
