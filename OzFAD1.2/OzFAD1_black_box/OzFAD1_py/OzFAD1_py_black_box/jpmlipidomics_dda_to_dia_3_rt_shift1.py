...
# Jan Philipp Menzel 
# Goal: Generate analysis of DIA dataset based on ID's from DDA analysis
...
trdf=pd.read_csv('skyl_report_dda_found.csv')
toprowx=[trdf.columns.values.tolist()]
toprow=toprowx[0]
trdf=trdf.transpose()
writelist=trdf.values.tolist()
ki=len(writelist[0])
print('Number of rows in skyl_report_dda_found.csv: %d' % ki)
#print(ki)
#####################################################################################################
