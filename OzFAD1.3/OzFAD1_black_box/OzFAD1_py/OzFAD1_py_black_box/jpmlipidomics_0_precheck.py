...
if gui==0:
	...
	if default==1:		# default analysis parameters
		...
		largeareathreshold=150
		largeareathreshold=eval(input('What is the threshold for detected precursor peak area? (compare Skyline report file, e.g. 150): '))
...
else:	#if gui used, read workflow parameters from excel file
